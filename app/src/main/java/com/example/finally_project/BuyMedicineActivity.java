...
public class BuyMedicineActivity extends AppCompatActivity {
    ...
    private String[] package_details = {
            ...
            "Chromium is an essential trace mineral that plays an important role in helping regular blood glucose.",
            "Provides relief prom vitamin B deficiencies\n" +
                    "It helps reduce skin blemish and pigmentation.\n" +
                    "It act as safeguard the skin from the harsh OVA and OVB sun rays.",
            ...
            "reduces the resi of calcium deficiency, Rickets, and Osteoporosis\n" +
