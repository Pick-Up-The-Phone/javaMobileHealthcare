...
public class DoctorDetailActivity extends AppCompatActivity {
    private String[][] doctor_details1 =
            {
                    ...
                    {"Doctor Name: Swapnil Kale", "Hospital Address: Pune", "Exp: 8yrs", "Mobile No:8898989898", "380"},
                    {"Doctor Name Deepak Deshmukh", "Hospital Address Chinchwad", "Exp: 6yrs", "Mobile No:9898888000", "500"},
    ...
    private String[][] doctor_details4 =
                {
                    ...
                    {"Doctor Name: Ashok Singh","Hospital Address: Katrai","Exp: 7yrs","Mobile No:7798989890","800"}
                };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i=0;i < doctor_details.length;i++){
            ...
            item.put("Line 5", "Cons Fees: "+doctor_details[i][4]+"UAH");
            list.add(item);
        }
