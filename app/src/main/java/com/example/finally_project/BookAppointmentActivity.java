...
public class BookAppointmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv = findViewById(R.id.textViewLTPPackageName);
        ...
        btnBack = findViewById(R.id.buttonBMCheckout);
        ...
        ed2.setText(address);
        ed3.setText(contact);
        ed4.setText("Cons Fees: " + fees + "UAH");
        ...
        btnBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(db.checkAppointmentExists(username, title+" => "+fullname, address,
                        contact, dateButton.getText().toString(), timeButton.getText().toString()) == 1){
